package com.example.richieye.wheel_menu;
...
/**
 * Created by RichieYe on 2016/6/2.
 */

public class CustomRoundButtonView extends ImageView {
    ...
    public CustomRoundButtonView(Context context) {
        super(context);
        mContext=context;
    }

    public CustomRoundButtonView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext=context;
    }

    public CustomRoundButtonView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {      //重写绘制组件的方法
        ...
        */
        ...
        canvas.drawCircle(defaultWidth/2-radius,defaultHeight/2-radius,radius,null);
